...
// NOTE: the previous site linked signup to app.openbook.ie/onboard; the brief
// specifies /onboarding. Using the brief's value — change here if the live
// app route differs.
...
export const COMPLETE_MAILTO =
  "mailto:sam@openhouseai.ie?subject=OpenBook%20Complete";
export const OPENHOUSE_URL = "https://openhouseai.ie";
