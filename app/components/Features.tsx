...
const FEATURES: Feature[] = [
  ...
  { name: 'Your booking page', desc: 'Your brand, your services, openbook.ie/your-name.', icon: 'globe' },
  { name: 'Consumer app icon', desc: 'Customers save you to their home screen. One tap.', icon: 'phone' },
  { name: 'Flash sales', desc: 'Fill quiet slots with timed, limited-seat offers.', icon: 'bolt' },
  { name: 'AI distribution', desc: 'Discoverable by ChatGPT, Claude and Gemini via MCP.', icon: 'spark', core: true },
  { name: 'WhatsApp bookings', desc: 'A WhatsApp bot that books without leaving the chat.', icon: 'chat' },
